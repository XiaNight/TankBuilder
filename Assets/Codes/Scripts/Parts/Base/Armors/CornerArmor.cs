...
public class CornerArmor : ArmorPlate
{
	...
	protected override void ConstructMesh(Mesh mesh, in ArmorValue[] av)
	{
		Vector3[] rawVerts = new Vector3[6]
		{
			...
			new(av[1].OffsetMeters, -Constants.HALF_GRID, -Constants.HALF_GRID),
			...
			new(av[2].ThicknessMeters + av[2].OffsetMeters, -Constants.HALF_GRID, -Constants.HALF_GRID),
